...
public class Message
    ...
    public void process(Packet packet, XMPPResourceConnection session, NonAuthUserRepository repo,
        ...
        //System.out.println("====Message=====process=1111=");
        ...
        try {
            ...
            //System.out.println("====Message=====process=id=" + id);
            // Checking if this is a packet TO the owner of the session

            //System.out.println("====Message=====session.isUserId(id)=" + session.isUserId(id));
            if (session.isUserId(id)) {
                ...
                if (packet.getStanzaFrom() != null && session.isUserId(packet.getStanzaFrom().getBareJID())) {
                    //System.out.println("====Message=====process=22222=" + packet.toString());
                ...
                //System.out.println("=====Message=====process==conns.size()=====" + conns.size());
                if (conns.size() > 0) {
                    for (XMPPResourceConnection con : conns) {
                        Packet result = packet.copyElementOnly();
                        //System.out.println("=====Message=====process==result==111===" + result.toString());
                        ...
                        // will be lost.
                       // System.out.println("=====Message=====process==result==2222===" + result.toString());
            ...
            //System.out.println("====Message=====process=session.getConnectionId()=" + session.getConnectionId());
