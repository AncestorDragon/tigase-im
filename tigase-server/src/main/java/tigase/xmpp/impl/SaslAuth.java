...
public class SaslAuth
	...
	public void process(final Packet packet, final XMPPResourceConnection session, final NonAuthUserRepository repo,
		...
		synchronized (session) {
			...
			//System.out.println("==process process ===" + session);
			...
			if (session.isAuthorized()) {
				...
				//System.out.println("======Start SASL request =======" + request.toString());
				try {
					SaslServer ss;
					...
					if ("auth" == request.getName()) {
						...
						//System.out.println("======Start SASL auth. mechanism =======" + mechanismName);
						...
						System.out.println("======Start SASL auth. mechanism ===2222====" + allowedMechanisms);
						...
						//System.out.println("======Start SASL auth. mechanism ==333===" + repo + "==settings===" + settings);
						CallbackHandler cbh = saslProvider.create(mechanismName, session, repo, settings);
						//System.out.println("======Start SASL auth. mechanism ==4444==" + cbh + "==props===" + props);
						...
						//System.out.println("=====SaslServer 111===" + ss);
						...
						//System.out.println("=====SaslServer 222===" + ss);
						if (ss == null) {
					...
					//System.out.println("=====SaslServer 333 ==" + cdata);
					...
					//System.out.println("=====SaslServer 333 =222222=" + Arrays.toString(data));
					...
					//System.out.println("=====SaslServer 333 =555=" + challengeData);
					if (ss.isComplete() && (ss.getAuthorizationID() != null)) {
						BareJID jid;
						//System.out.println("=====SaslServer 4444 ==" + ss);
						...
						//System.out.println("=====SaslServer Authorized as=" + jid);
						boolean anonymous;
						...
						//System.out.println("=====doAuth===444==== " + anonymous);
						...
						//System.out.println("=====doAuth===ss.isComplete()==== " + ss.isComplete());
					...
					//System.out.println("=====doAuth===LoginLockedException==== ");
					onAuthFail(session);
					...
					//System.out.println("=====doAuth===XmppSaslException==== ");
					...
					//System.out.println("=====doAuth===SaslException==== ");
					saveIntoBruteForceLocker(session, e);
					onAuthFail(session);
					if (log.isLoggable(Level.FINER)) {
						log.log(Level.FINER, "SASL unsuccessful", e);
					...
					//System.out.println("=====doAuth===Exception=Exception==== ");
					onAuthFail(session);
