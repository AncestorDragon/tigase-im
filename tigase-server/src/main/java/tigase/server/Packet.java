...
public class Packet {
    ...
    public static Packet packetInstance(Element elem) throws TigaseStringprepException {
        ...
        if (elem.getName() == Message.ELEM_NAME) {
            System.out.println("=======packetInstance==222====" + elem.getChild("delay"));
            if(elem.getChild("delay") == null) {
                Element elementA = new Element("timestamp", String.valueOf(System.currentTimeMillis()));
                elem.addChild(elementA);
    ...
    public String toStringFull() {
        if (packetToString == null) {
            ...
            //System.out.println("====toStringFull===elemData=====" + elemData  + "==elem==" + elem.toString());
    ...
    public String toStringSecure() {
        if (FULL_DEBUG) {
            ...
            if (packetToStringSecure == null) {
                ...
                //System.out.println("====toStringSecure===elemData=====" + elemData  + "==elem==" + elem.toString());
